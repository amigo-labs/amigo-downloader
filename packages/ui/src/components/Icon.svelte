...
>
  ...
  {:else if name === "wifi-off"}
    <path d="M2 2l20 20M8.5 16.5a5 5 0 017 0M5 12.55a10.94 10.94 0 015.17-2.39M10.71 5.05A16 16 0 0122.58 9M1.42 9a15.91 15.91 0 014.7-2.88M16.85 11.25a10.94 10.94 0 011.95 1.3" />
    <path d="M12 20h.01" />
  {:else if name === "file"}
